<script lang="ts">
	...
	const links = [
		...
		{ href: '/gameweek', label: 'מחזור' },
		{ href: '/options', label: 'אפשרויות קבוצה' },
		{ href: '/transfers', label: 'הצעות חילופים' }
	];
		...
		<nav class="flex flex-wrap gap-2">
			{#each links as link}
				...
				<a
					...
					style={active
						? 'background:#064e3b;color:#a7f3d0;border:1px solid #34d399;opacity:1'
						: 'background:#334155;color:#ffffff;border:1px solid #94a3b8;opacity:1'}
				>
					{link.label}
				</a>
			{/each}
